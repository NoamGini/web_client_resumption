    ...
    async function getData(usernameOfUser, passwordOfUser) {
        ...
        try {
            var response = await axios.get(
                "http://"+domain+"/api/Users?username=" + usernameOfUser + "&password=" + passwordOfUser,
    ...
    return (
        <div className="container">
            ...
            <div className="outterBlock">
                ...
                <div className="register-link">Hi there! to rate our website please <a href="http://localhost:5240" className="link-success">click here!</a></div>
            </div>
        </div>
    );
}
